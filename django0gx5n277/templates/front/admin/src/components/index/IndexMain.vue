<template>
	<div style="height: 100%;">
		<el-main :style='"vertical" == "vertical" ? (2 == 1 ? {"minHeight":"100%","padding":"0","margin":"0 0 0 210px","position":"relative","display":"block"} : (2 == 2 ? (isCollapse ? {"minHeight":"100%","padding":"0","margin":"0 0 0 64px","position":"relative","display":"block"} : {"minHeight":"100%","padding":"100px 0 0 210px","margin":"20px 0  0 0","position":"relative","background":"#E5E5E5","display":"block"}) : "")) : {"minHeight":"100%","margin":"0","position":"relative"}'>
			<!-- top -->
			<index-header :style='{"padding":"0 20px 0","alignItems":"center","color":"#FFFFFF","display":"flex","justifyContent":"flex-end","top":"0","left":"0","background":"#0000FF","width":"100%","fontSize":"16px","position":"fixed","zIndex":"999","height":"100px"}'></index-header>
			...
			<!-- breadcrumb -->
			<bread-crumbs :title="title" :style='{"padding":"20px ","margin":"0px auto 0 20px","borderColor":"#0000FF","borderWidth":"2px 0 0 0","background":"#F3F3F3","width":"calc(100% - 40px)","fontSize":"14px","borderStyle":"solid","fontWeight":"400"}' class="bread-crumbs"></bread-crumbs>
